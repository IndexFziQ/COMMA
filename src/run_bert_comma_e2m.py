...
from utils.dataset_utils_mber import (Emotion2Motive_Processor, emotion2motive_convert_examples_to_features)
...
processor = None
PROCESSORS = {
    'mber.e2m': Emotion2Motive_Processor,
}

CONVERTER = {
    "mber.e2m": (emotion2motive_convert_examples_to_features, None),
}

# TaskName_NetworkName
MODEL_CLASSES = {
    "mber.e2m_basic_bert": (BertConfig, BertForSequenceClassification, BertTokenizer),
    "mber.e2m_basic_roberta": (RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer),
}
