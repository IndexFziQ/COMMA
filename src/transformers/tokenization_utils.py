...
class PreTrainedTokenizer(object):
    ...
    def _from_pretrained(cls, pretrained_model_name_or_path, *init_inputs, **kwargs):
        ...
        # Get files from url, cache, or disk depending on the result
        try:
    ...
    def num_added_tokens(self, pair=False):
        ...
        Args:
            pair: Returns the number of added tokens in the result of a sequence pair if set to True, returns the
                number of added tokens in the result of a single sequence if set to False.
