...
TASK_NAME='lmft'
NET_NAME='lm'
M_NAME='gpt2_action_generation_with_ep'
...
OUTPUT_BASE=/your_checkpoint_path/checkpoints_ft_with_comma_action_generation_with_ep
...
python -u /your_file_path/COMMA/src/run_action_generation_with_emotion_predition.py \
